<%@ Page Title="" Language="C#" MasterPageFile="~/DCMSMasterPage.Master" AutoEventWireup="true" CodeBehind="EditAppointmentAdmin.aspx.cs" Inherits="DCMS.EditAppointmentAdmin" %>
...
<table style="width:500px;margin:0 auto;margin-top:auto;background-color:#ACFF67">
    ...
    <tr>
        ...
        <td class="style2">
            <asp:DropDownList
                ID="ddlDoctor" DataTextField="Name" DataValueField="Name" runat="server" Width="150px">
            </asp:DropDownList>
        </td>
    </tr>
    <tr>
